 ...
 *       "add_by_query" = "Drupal\search_overrides\Form\SearchOverrideAddByQueryForm",
...
class SearchOverride extends ContentEntityBase {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['elnid'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Promoted Content'))
      ->setDescription(t('Content that should appear at the top of the results.'))
      ->setTranslatable(TRUE)
    ...
    $fields['exnid'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Excluded Content'))
      ->setDescription(t('Content that should NOT appear in the results.'))
      ->setTranslatable(TRUE)
      ->setCardinality(FieldStorageDefinitionInterface::CARDINALITY_UNLIMITED)
      ->setDisplayOptions('view', [
        'label' => 'above',
